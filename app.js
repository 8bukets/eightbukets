...
class PromptVariable {
    constructor(raw, name, hint, escapedVariable) {
        this.raw = raw;
        this.name = name;
        this.hint = hint;
        this._escapedVariable = escapedVariable;
        this._replaceRegex = null;
    }

    get replaceRegex() {
        if (!this._replaceRegex) {
            this._replaceRegex = new RegExp(`\\[${this._escapedVariable}\\]`, 'g');
        }
